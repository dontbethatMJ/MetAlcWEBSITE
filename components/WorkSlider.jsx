            ...
            {slide.images.map((image, imageI) => (
              ...
              >
                <div className="flex items-center justify-center relative overflow-hidden group">
                  ...
                  {/* title */}
                  <div className="absolute bottom-0 translate-y-full group-hover:-translate-y-10 group-hover:xl:-translate-y-20 transition-all duration-300 flex items-center justify-center w-full">
                    <Link
                      href={image.link}
                      target="_blank"
                      rel="noreferrer noopener"
                      className="flex items-center gap-x-2 text-[clamp(10px,2vw,13px)] tracking-[0.2em] text-center"
                    >
                      {/* title part 1 */}
